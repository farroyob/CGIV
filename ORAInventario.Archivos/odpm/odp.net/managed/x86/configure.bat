...
REM set TNS_ADMIN
if {%2} NEQ {} (
echo reg add "HKEY_LOCAL_MACHINE\SOFTWARE\%ODAC_CFG_PREFIX%Oracle\ODP.NET.Managed\4.122.21.1" /v TNS_ADMIN /t REG_SZ /d %2 /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\%ODAC_CFG_PREFIX%Oracle\ODP.NET.Managed\4.122.21.1" /v TNS_ADMIN /t REG_SZ /d %2 /f
)
...
echo.
echo reg add "HKEY_LOCAL_MACHINE\SOFTWARE\%ODAC_CFG_PREFIX%Microsoft\.NETFramework\v4.0.30319\AssemblyFoldersEx\Oracle.ManagedDataAccess" /ve /t REG_SZ /d %PATH_ONE_LEVEL_UP%\common /f
reg add "HKEY_LOCAL_MACHINE\SOFTWARE\%ODAC_CFG_PREFIX%Microsoft\.NETFramework\v4.0.30319\AssemblyFoldersEx\Oracle.ManagedDataAccess" /ve /t REG_SZ /d %PATH_ONE_LEVEL_UP%\common /f
echo.
